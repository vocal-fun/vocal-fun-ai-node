...
if ENABLE_LOCAL_MODEL:
    ...
    config = XttsConfig()
    config.load_json("/home/ec2-user/.local/share/tts/xtts_finetuned/config.json")
    model = Xtts.init_from_config(config)
    model.load_checkpoint(config, checkpoint_dir="/home/ec2-user/.local/share/tts/xtts_finetuned", use_deepspeed=True)
    model.cuda()
